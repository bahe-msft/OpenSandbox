...
- [`aa09252`](https://github.com/bahe-msft/OpenSandbox/commit/aa092522b814714b5e337d0fc1df4057f69bf75e) — Skipped code-interpreter and removed the Windows execd binary from AKS image publishing to reduce publish time.
